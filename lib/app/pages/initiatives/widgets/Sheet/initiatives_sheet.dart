            ...
            child: Form(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Nova iniciativa",
                        style:
                            TextStyles.instance.regular.copyWith(fontSize: 20)),
                    InputSheet(
                        campoTexto: "Nome",
                        entradaExemplo: "Kuth",
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          var playersProvider = context.read<PlayersProvider>();
                          playersProvider.addPlayer(Players(
